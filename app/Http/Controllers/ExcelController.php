...
class ExcelController extends Controller
{
  ...
  public function export1()
  {
    ...
    Excel::create('requirement1',function ($excel) use($result1){
        $excel->sheet("1", function ($sheet) use ($result1){
          $sheet->rows($result1);
  ...
  public function export2()
  {
    ...
    Excel::create('requirement2',function ($excel) use($result2){
          $excel->sheet("2",function($sheet) use($result2){
            $rno=0;
            $gno=0;
            $bno=0;
            $j=0;
         ...
         $sheet->mergeCells('C3:V5');
         $sheet->getCell('C3')->setValue('Printed Date:');
         $sheet->setBorder('C3','thin');
         $sheet->mergeCells('X3:AS5');
         $sheet->setBorder('X3','thin');
         $sheet->mergeCells('BA3:BN5');
         $sheet->getCell('BA3')->setValue('Lot No:');
         $sheet->setBorder('BA3','thin');
         $sheet->mergeCells('BQ3:CC5');
         $sheet->setBorder('BQ3','thin');
         $sheet->mergeCells('CZ3:DN5');
         $sheet->getCell('CZ3')->setValue('Name:');
         $sheet->setBorder('CZ3','thin');
         $sheet->mergeCells('DR3:EF5');
         $sheet->setBorder('DR3','thin');
         $sheet->mergeCells('CZ9:DN11');
         $sheet->getCell('CZ9')->setValue('Date:');
         $sheet->setBorder('CZ9','thin');
         $sheet->mergeCells('DR9:EF11');
         $sheet->setBorder('DR9','thin');
         $sheet->mergeCells('FK3:GE5');
         $sheet->getCell('FK3')->setValue('Defect record');
         $sheet->setBorder('FK3','thin');
         $sheet->mergeCells('FK9:FO9');
         $sheet->getCell('FK9')->setValue('R:');
         $sheet->setBorder('FK9','thin');
         $sheet->mergeCells('FP9:GE9');
         $sheet->getCell('FP9')->setValue($rno);
         $sheet->setBorder('FP9','thin');
         $sheet->mergeCells('FK10:FO10');
         $sheet->getCell('FK10')->setValue('G:');
         $sheet->setBorder('FK10','thin');
         $sheet->mergeCells('FP10:GE10');
         $sheet->getCell('FP10')->setValue($gno);
         $sheet->setBorder('FP10','thin');
         $sheet->mergeCells('FK11:FO11');
         $sheet->getCell('FK11')->setValue('B:');
         $sheet->setBorder('FK11','thin');
         $sheet->mergeCells('FP11:GE11');
         $sheet->getCell('FP11')->setValue($bno);
         $sheet->setBorder('FP11','thin');
  ...
  public function export3()
  {
    ...
    Excel::create('requirement3',function ($excel) use($result2,$chip,$pixel){
          $excel->sheet("3", function ($sheet) use ($result2,$chip,$pixel){
            $result3=array();
            foreach($result2 as $v)
            {
              if($v['color']=="R")
